...
static const yytype_uint8 yytranslate[] =
{
       ...
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,    37,     2,     2,     2,     2,    46,     2,
      40,    38,     2,     2,     2,     2,     2,    39,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      43,    42,    41,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,    72,    72,    76,    78,    80,    81,    82,    83,    84,
      86,    88,    90,    91,    92,    94,    99,   100,   101,   102,
     103,   104,   108,   110,   112,   114,   115,   116,   118,   119,
...
{
  "$end", "error", "$undefined", "OUTER", "INNER", "DST", "SRC", "HOST",
  "NET", "NETMASK", "PORT", "PORTRANGE", "PROTO", "ARP", "RARP", "IP",
  "SCTP", "TCP", "UDP", "NUM", "DIR", "LINK", "GEQ", "LEQ", "NEQ", "ID",
  "EID", "HID", "HID6", "IPV6", "VLAN", "MPLS", "GTP", "L7PROTO", "QUOTED",
  "OR", "AND", "'!'", "')'", "'/'", "'('", "'>'", "'='", "'<'", "'['",
  "']'", "'&'", "$accept", "prog", "null", "expr", "and", "or", "id",
  "nid", "not", "paren", "pid", "qid", "term", "head", "rterm", "hqual",
  "pqual", "dqual", "aqual", "pname", "other", "relop", "irelop", "narth",
  "pnum", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     285,   286,   287,   288,   289,   290,   291,    33,    41,    47,
      40,    62,    61,    60,    91,    93,    38
};
# endif
...
{
     -42,     1,    94,   -42,   -42,   -42,   -42,   -42,   -42,   -42,
     -42,   -17,   -42,    -6,    -6,   -42,    -3,   -42,   -42,    -5,
     187,   187,   -42,    44,   -42,    70,   223,     7,   -42,    35,
     -42,   -42,   -42,    -6,   -42,   -42,   -42,   -42,   -42,   -42,
     125,   125,   -42,    14,   -42,   -42,    -4,   -30,   -42,   -42,
      44,    44,   -42,   231,   -42,    20,    29,   -42,   -42,   -42,
     -42,   -42,   106,   -42,    -6,   -42,   -42,   -42,   -42,   -42,
     -42,    -6,    -6,   -24,   -17,   -42,   125,   125,   -42,   -42,
     -42,   -42,    -7,    21,    25,   -42,   -42,   -13,    -5,   -24,
     -42,   106,   -42,    54,    60,    68,    74,   -42,    45,   -42,
     -42,   -42,   156,   -42,   -42,   -42,   -42,    44,    44,   -42,
     -42,   -42,   -42,   -42,    34,   -42,   -42,    -6,   -42
};
...
{
       4,     0,    53,     1,    50,    51,    65,    66,    67,    68,
      64,     0,    69,    71,    73,    74,     0,    23,    24,     2,
      53,    53,     5,     0,    30,    53,     0,    52,    47,     0,
      49,    48,    83,     0,    70,    72,    41,    42,    11,    10,
      53,    53,    31,     0,    15,    21,    18,    20,    40,    12,
       0,     0,    13,     0,    52,    55,    54,    60,    61,    62,
      63,    39,    35,    37,     0,    76,    78,    80,    75,    77,
      79,     0,     0,     0,    15,     7,    53,    53,     6,     9,
       8,    43,     0,     0,     0,    22,    25,    29,     0,    28,
      38,    34,    36,     0,     0,     0,     0,    33,     0,    45,
      46,    84,    53,    17,    16,    19,    14,     0,     0,    32,
      57,    59,    56,    58,    81,    26,    27,     0,    82
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -42,   -42,   -42,    87,     5,    13,   -12,   -41,     6,    -2,
     -42,   -42,    -8,   -42,   -42,   -42,    77,    50,   -38,    79,
     -42,   -42,   -42,   -42,   -10
};
...
{
      -1,     1,     2,    43,    40,    41,    85,    49,    50,    33,
      87,    88,    22,    23,    24,    25,    26,    62,    63,    27,
      28,    71,    72,    29,    52
};
...
{
      21,     3,    30,    34,    35,    82,    37,   -44,    20,    84,
      86,    48,    42,    32,   101,    92,    32,    31,    21,    21,
     103,    51,    36,    73,    97,   106,    20,    20,    75,    79,
      38,    39,    78,    80,    18,    83,    86,    18,    77,    77,
     104,    89,   -44,   -44,   105,   -44,    76,    76,    51,    38,
      39,    64,    81,   109,    98,    93,    94,    65,    66,    67,
     110,    99,   100,    32,    95,    96,   111,    89,    42,    44,
      45,    46,    47,   112,    77,   102,    68,    69,    70,   113,
     117,    17,    76,    76,    18,     6,     7,     8,     9,    19,
     114,    10,    73,   107,    -3,   115,   116,     4,     5,    12,
     102,   108,    53,    91,    54,    51,    51,   118,    20,     6,
       7,     8,     9,    57,    58,    10,    59,    60,     0,    11,
       0,     0,     0,    12,    13,    14,    15,    16,     4,     5,
       0,    17,     0,     0,    18,     0,     0,     0,     0,     0,
       6,     7,     8,     9,    32,     0,    10,     0,     0,     0,
      74,    45,    46,    47,    12,    13,    14,    15,    16,     4,
       5,     0,    17,     0,     0,    18,     0,     0,     0,     0,
       0,     6,     7,     8,     9,    32,     0,    10,     0,     0,
       0,    11,     0,     0,     0,    12,    13,    14,    15,    16,
       4,     5,     0,    17,     0,     0,    18,     0,     0,     0,
       0,     0,     6,     7,     8,     9,     0,     0,    10,     0,
       0,     0,    11,     0,     0,     0,    12,    13,    14,    15,
      16,     0,     0,     0,    17,     0,     0,    18,    55,    56,
      57,    58,     0,    59,    60,    61,    55,    56,    57,    58,
       0,    59,    60,    90
};

static const yytype_int8 yycheck[] =
{
       2,     0,    19,    13,    14,     9,    16,     0,     2,    39,
      51,    23,    20,    19,    38,    53,    19,    34,    20,    21,
      27,    23,    25,    33,    62,    38,    20,    21,    40,    41,
      35,    36,    40,    41,    40,    39,    77,    40,    40,    41,
      19,    51,    35,    36,    19,    38,    40,    41,    50,    35,
      36,    44,    38,    91,    64,    35,    36,    22,    23,    24,
       6,    71,    72,    19,    35,    36,     6,    77,    76,    25,
      26,    27,    28,     5,    76,    77,    41,    42,    43,     5,
      46,    37,    76,    77,    40,    15,    16,    17,    18,     2,
      45,    21,   102,    88,     0,   107,   108,     3,     4,    29,
     102,    88,    25,    53,    25,   107,   108,   117,   102,    15,
      16,    17,    18,     7,     8,    21,    10,    11,    -1,    25,
      -1,    -1,    -1,    29,    30,    31,    32,    33,     3,     4,
      -1,    37,    -1,    -1,    40,    -1,    -1,    -1,    -1,    -1,
      15,    16,    17,    18,    19,    -1,    21,    -1,    -1,    -1,
      25,    26,    27,    28,    29,    30,    31,    32,    33,     3,
       4,    -1,    37,    -1,    -1,    40,    -1,    -1,    -1,    -1,
      -1,    15,    16,    17,    18,    19,    -1,    21,    -1,    -1,
      -1,    25,    -1,    -1,    -1,    29,    30,    31,    32,    33,
       3,     4,    -1,    37,    -1,    -1,    40,    -1,    -1,    -1,
      -1,    -1,    15,    16,    17,    18,    -1,    -1,    21,    -1,
      -1,    -1,    25,    -1,    -1,    -1,    29,    30,    31,    32,
      33,    -1,    -1,    -1,    37,    -1,    -1,    40,     5,     6,
       7,     8,    -1,    10,    11,    12,     5,     6,     7,     8,
      -1,    10,    11,    12
};
...
{
       0,    48,    49,     0,     3,     4,    15,    16,    17,    18,
      21,    25,    29,    30,    31,    32,    33,    37,    40,    50,
      55,    56,    59,    60,    61,    62,    63,    66,    67,    70,
      19,    34,    19,    56,    71,    71,    25,    71,    35,    36,
      51,    52,    59,    50,    25,    26,    27,    28,    53,    54,
      55,    56,    71,    63,    66,     5,     6,     7,     8,    10,
      11,    12,    64,    65,    44,    22,    23,    24,    41,    42,
      43,    68,    69,    71,    25,    53,    55,    56,    59,    53,
      59,    38,     9,    39,    39,    53,    54,    57,    58,    71,
      12,    64,    65,    35,    36,    35,    36,    65,    71,    71,
      71,    38,    56,    27,    19,    19,    38,    51,    52,    65,
       6,     6,     5,     5,    45,    53,    53,    46,    71
};
...
#line 194 "grammar.y" /* yacc.c:1906  */
